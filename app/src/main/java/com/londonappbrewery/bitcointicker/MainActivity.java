    ...
    private void letsDoSomeNetworking(String url, RequestParams params) {
        ...
        client.get(BASE_URL, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Log.d("Bitcoin","the json is:" + response.toString());



                Bitcoinresult Newresult = Bitcoinresult.fromjson(response);



                mPriceTextView.setText(Newresult.getMprice());
